# air passengers datasets apply long short term memory RNN
import numpy as np
import pandas as pd
...
data = pd.read_csv('Machine_learning_practice/AirPassengers.csv')
data['Month'] = pd.to_datetime(data['Month'])
data.set_index('Month', inplace=True)
production = data['#Passengers'].astype(float).values.reshape(-1, 1)
